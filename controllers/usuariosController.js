...
class UsuariosController {
    ...
    listarUsuariosRol(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const resp = yield database_1.default.query(`SELECT nombre, tipo FROM  usuarios LEFT JOIN roles on usuarios.TipoUsuario = tipousuario.id_tipo WHERE usuarios.TipoUsuario = ${id};`);
            res.json(resp);
        });
    }
    ValidarUsuario(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var consulta = `SELECT id_Rol, correo FROM usuarios WHERE correo = '${parametros.correo}' AND password = '${parametros.contrasena}'`;
